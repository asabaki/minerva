...
const s3 = new aws.S3();
// const readFile = new aws.S3().listObjects({Bucket: 'minerva-project', MaxKeys: 10}, function(err,data) {
//   // console.log(data);
// });
...
router.get('/all/profile', (req, res) => {
  s3.listObjectsV2({Bucket: "minerva-project", MaxKeys: 10, EncodingType: 'url',}, function (err, data) {
    // data = data
    //   .map(obj => obj.key);
    ...
    //   obj = obj.substring(12);
    //   console.log(obj);
    //   // obj.toString().splice(0,12);
    //   // console.log(obj);
    // });
    // console.log(objKey);
    // console.log(data);
